...
function Input({
  ...
  const displayValue = React33.useMemo(() => {
  ...
  return /* @__PURE__ */ React33.createElement("div", { className: cn("uii:mb-2", className) }, /* @__PURE__ */ React33.createElement("div", { className: "uii:flex uii:items-center uii:gap-2 uii:mt-2" }, /* @__PURE__ */ React33.createElement(
    ...
    label,
    ":"
  ), resolvedExpectedType !== "$.interface.timer" && /* @__PURE__ */ React33.createElement(
    "span",
    {
      className: cn(
...
function createSlot(ownerName) {
  ...
  const Slot22 = React33.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return /* @__PURE__ */ jsx(SlotClone, { ...slotProps, ref: forwardedRef, children: React33.isValidElement(newElement) ? React33.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createCollection(name) {
  ...
  const CollectionProvider = (props) => {
    ...
    const itemMap = React33__default.useRef(/* @__PURE__ */ new Map()).current;
    return /* @__PURE__ */ jsx(CollectionProviderImpl, { scope, itemMap, collectionRef: ref, children });
  };
  CollectionProvider.displayName = PROVIDER_NAME;
  const COLLECTION_SLOT_NAME = name + "CollectionSlot";
  const CollectionSlotImpl = createSlot(COLLECTION_SLOT_NAME);
  const CollectionSlot = React33__default.forwardRef(
    (props, forwardedRef) => {
      const { scope, children } = props;
  ...
  const CollectionItemSlot = React33__default.forwardRef(
    (props, forwardedRef) => {
  ...
  function useCollection2(scope) {
    ...
    const getItems = React33__default.useCallback(() => {
...
var Primitive = NODES.reduce((primitive, node) => {
  ...
  const Node2 = React33.forwardRef((props, forwardedRef) => {
...
function useCallbackRef(callback) {
  ...
  return React33.useMemo(() => (...args) => callbackRef.current?.(...args), []);
}
...
var DismissableLayerContext = React33.createContext({
  layers: /* @__PURE__ */ new Set(),
  layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(),
  branches: /* @__PURE__ */ new Set()
});
var DismissableLayer = React33.forwardRef(
  (props, forwardedRef) => {
    const {
    ...
    const context = React33.useContext(DismissableLayerContext);
    const [node, setNode] = React33.useState(null);
    const ownerDocument = node?.ownerDocument ?? globalThis?.document;
    const [, force] = React33.useState({});
...
var DismissableLayerBranch = React33.forwardRef((props, forwardedRef) => {
  const context = React33.useContext(DismissableLayerContext);
...
function usePointerDownOutside(onPointerDownOutside, ownerDocument = globalThis?.document) {
  ...
  const isPointerInsideReactTreeRef = React33.useRef(false);
  const handleClickRef = React33.useRef(() => {
  });
  React33.useEffect(() => {
...
function useFocusOutside(onFocusOutside, ownerDocument = globalThis?.document) {
  ...
  const isFocusInsideReactTreeRef = React33.useRef(false);
  React33.useEffect(() => {
...
var useLayoutEffect2 = globalThis?.document ? React33.useLayoutEffect : () => {
};

// ../../node_modules/.pnpm/@radix-ui+react-id@1.1.1_@types+react@19.2.2_react@19.2.2/node_modules/@radix-ui/react-id/dist/index.mjs
var useReactId = React33[" useId ".trim().toString()] || (() => void 0);
var count2 = 0;
function useId(deterministicId) {
  const [id, setId] = React33.useState(useReactId());
  useLayoutEffect2(() => {
...
function useControllableState({
  ...
  {
    const isControlledRef = React33.useRef(prop !== void 0);
    React33.useEffect(() => {
...
function useUncontrolledState({
  ...
  const [value, setValue] = React33.useState(defaultProp);
  const prevValueRef = React33.useRef(value);
  const onChangeRef = React33.useRef(onChange);
  useInsertionEffect(() => {
...
function Select2({
  ...
  return /* @__PURE__ */ React33.createElement(Root22, { "data-slot": "select", ...props });
}
function SelectGroup2({
  ...props
}) {
  return /* @__PURE__ */ React33.createElement(Group, { "data-slot": "select-group", ...props });
}
function SelectValue2({
  ...props
}) {
  return /* @__PURE__ */ React33.createElement(Value, { "data-slot": "select-value", ...props });
}
...
function SelectContent2({
  ...
  return /* @__PURE__ */ React33.createElement(Portal2, null, /* @__PURE__ */ React33.createElement(
    Content2,
    {
    ...
    !hideScrollUpButton && /* @__PURE__ */ React33.createElement(SelectScrollUpButton2, null),
    ...
    footer ? /* @__PURE__ */ React33.createElement("div", { className: "uii:border-t uii:p-2 uii:bg-popover" }, footer) : null,
    !hideScrollDownButton && /* @__PURE__ */ React33.createElement(SelectScrollDownButton2, null)
  ));
}
...
function Select3({
  ...
  const [isExpressionMode, setIsExpressionMode] = React33.useState(false);
  const [expressionValue, setExpressionValue] = React33.useState("");
  ...
  const handleSelectChange = React33.useCallback((newValue) => {
  ...
  return /* @__PURE__ */ React33.createElement("div", { className: cn("uii:mb-2", className) }, /* @__PURE__ */ React33.createElement("div", { className: "uii:flex uii:items-center uii:gap-2 uii:mt-2" }, /* @__PURE__ */ React33.createElement(
    ...
    resolvedExpectedType
  ), showError && /* @__PURE__ */ React33.createElement("span", { className: "uii:-mt-2 uii:inline-flex uii:px-1 uii:py-0.5 uii:bg-red-100 uii:text-red-600 uii:rounded-sm uii:text-[10px] uii:font-medium" }, "Required")), /* @__PURE__ */ React33.createElement("div", { className: "uii:mt-0.5" }, children ? (
    // Use custom render function
    children(renderProps)
  ) : isExpressionMode ? (
    // Expression mode - show input with clear button
    /* @__PURE__ */ React33.createElement("div", { className: "uii:flex uii:items-center uii:h-9 uii:rounded-sm uii:border uii:border-amber-500/50 uii:bg-amber-500/5" }, /* @__PURE__ */ React33.createElement(
      "input",
      {
        id: fieldName,
        name: fieldName,
    ...
    /* @__PURE__ */ React33.createElement(
      ...
      /* @__PURE__ */ React33.createElement(
        ...
        /* @__PURE__ */ React33.createElement(SelectValue2, { placeholder })
      ),
      /* @__PURE__ */ React33.createElement(SelectContent2, null, renderSelectSegments(groupedOptions))
    )
  )));
}
function renderSelectSegments(segments) {
  return segments.map((segment, idx) => {
    const items = segment.items.map((opt) => /* @__PURE__ */ React33.createElement(SelectItem2, { key: opt.value, value: opt.value }, opt.node ? opt.node : /* @__PURE__ */ React33.createElement(React33.Fragment, null, opt.label)));
    if (!segment.heading) {
      return /* @__PURE__ */ React33.createElement(React33.Fragment, { key: `__ungrouped_${idx}` }, items);
    }
    return /* @__PURE__ */ React33.createElement(SelectGroup2, { key: segment.heading.key }, /* @__PURE__ */ React33.createElement(SelectLabel2, null, segment.heading.label), items);
  });
}
var REACT_LAZY_TYPE = Symbol.for("react.lazy");
var use = React33[" use ".trim().toString()];
...
function TemplateFieldProvider({ children }) {
  return /* @__PURE__ */ React33__default.createElement(React33__default.Fragment, null, children);
}

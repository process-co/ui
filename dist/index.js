...
import React45__default, { forwardRef, createElement, createContext, useLayoutEffect, useId as useId$1, useState, useContext, useCallback, useEffect } from 'react';
...
function clamp(start, value, end3) {
  return max(start, min(value, end3));
}
...
var MenuPortal = (props) => {
  ...
  return /* @__PURE__ */ jsx(PortalProvider, { scope: __scopeMenu, forceMount, children: /* @__PURE__ */ jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx(Portal, { asChild: true, container, children }) }) });
};
...
// ../../node_modules/.pnpm/lucide-react@0.476.0_react@19.2.6/node_modules/lucide-react/dist/esm/icons/chevron-right.js
...
// ../../node_modules/.pnpm/lucide-react@0.476.0_react@19.2.6/node_modules/lucide-react/dist/esm/icons/circle.js
...
function ConfirmationDropdownMenuItem({
  ...
  return !isConfirming ? /* @__PURE__ */ React45.createElement(DropdownMenuItem2, { ...rest, onClick: (e2) => {
    setIsConfirming(true);
    e2.preventDefault();
    e2.stopPropagation();
  } }) : /* @__PURE__ */ React45.createElement(DropdownMenuItem2, { ...rest, onClick: (e2) => {
    if (originalOnClick) {
...
__export(fields_exports, {
  ...
  isSelectGroupHeading: () => isSelectGroupHeading,
  ...
  renderSelectSegments: () => renderSelectSegments,
  ...
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM4.createPortal(
        /* @__PURE__ */ jsx(SelectContentProvider, { scope: props.__scopeSelect, children: /* @__PURE__ */ jsx(Collection3.Slot, { scope: props.__scopeSelect, children: /* @__PURE__ */ jsx("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: /* @__PURE__ */ jsx(Combination_default, { as: Slot3, allowPinchZoom: true, children: /* @__PURE__ */ jsx(
          FocusScope,
          {
            asChild: true,
...
function SelectGroup2({
  ...
  return /* @__PURE__ */ React45.createElement(Group3, { "data-slot": "select-group", ...props });
}
...
function Select3({
  ...
  const groupedOptions = React45.useMemo(
  ...
  return /* @__PURE__ */ React45.createElement("div", { className: cn("uii:mb-2", className) }, /* @__PURE__ */ React45.createElement("div", { className: "uii:flex uii:items-center uii:gap-2 uii:mt-2" }, /* @__PURE__ */ React45.createElement(
    ...
    /* @__PURE__ */ React45.createElement(
      ...
      {
        value: displayValue,
        onValueChange: (e2) => handleSelectChange(e2),
      ...
      /* @__PURE__ */ React45.createElement(SelectContent2, null, renderSelectSegments(groupedOptions))
    )
  )));
}
function renderSelectSegments(segments) {
  return segments.map((segment, idx) => {
    const items = segment.items.map((opt) => /* @__PURE__ */ React45.createElement(SelectItem2, { key: opt.value, value: opt.value }, opt.node ? opt.node : /* @__PURE__ */ React45.createElement(React45.Fragment, null, opt.label)));
    if (!segment.heading) {
      return /* @__PURE__ */ React45.createElement(React45.Fragment, { key: `__ungrouped_${idx}` }, items);
    }
    return /* @__PURE__ */ React45.createElement(SelectGroup2, { key: segment.heading.key }, /* @__PURE__ */ React45.createElement(SelectLabel2, null, segment.heading.label), items);
  });
}
...
function convertSVG(abstractObj) {
  var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
  var _params$ceFn = params.ceFn, ceFn = _params$ceFn === void 0 ? abstractObj.tag === "svg" ? createElementNS : createElement16 : _params$ceFn;
...
function convert(createElement17, element, extraProps = {}) {
  ...
  return createElement17(element.tag, { ...attrs, ...remaining }, ...children);
}
var makeReactConverter = convert.bind(null, React45__default.createElement);
...
function getClassListFromProps(props) {
  ...
  if (flip4 === true) result.push(STYLE_CLASSES.flip);
  if (flip4 === "horizontal" || flip4 === "both") {
    result.push(STYLE_CLASSES.flipHorizontal);
  }
  if (flip4 === "vertical" || flip4 === "both") {
    result.push(STYLE_CLASSES.flipVertical);
  }
  if (size4 !== void 0 && size4 !== null) result.push(SIZE_CLASSES[size4]);
...
var FontAwesomeIcon = React45__default.forwardRef((props, ref) => {
